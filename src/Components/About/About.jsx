  ...
  return (
    <div className="section about_section" data-aos="fade-down">
      ...
      <div className="large_secondary_text">
        ...
        <br />
        <br />
        I&lsquo;m currently a grade 11 student from the Waterloo region who&lsquo;s looking forward
        ...
        <br />
        <br />
        One of my strongest strengths is my background in mathematics, which I love to use to tackle
        any challenges that come my way. I&lsquo;m constantly challenging myself to keep my mind
        sharp, whether it be through math contests, competitive programming, or a casual game of
        chess.
        <br />
        ...
        {/* <br />I have a strong background in mathematics, and love to constantly challenge my
